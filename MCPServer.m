...
- (NSDictionary *)handleToolsList:(id)reqId {
    NSArray *tools = @[
        ...
        // ---- go-ios integration: system monitoring ----
        @{
            @"name": @"get_sysmontap",
            @"description": @"Get real-time system metrics snapshot: CPU usage per-core, memory stats (free/active/wired/compressed), system load average, process count, disk I/O, and uptime. Like go-ios sysmontap but as an on-device single-shot snapshot.",
            @"inputSchema": @{
                @"type": @"object",
                @"properties": @{
                    @"interval": @{@"type": @"number", @"description": @"Not used for snapshot mode; reserved for future streaming (default: 1)"}
                }
            }
        },
        @{
            @"name": @"list_processes",
            @"description": @"List all running processes with PID, name, parent PID, and start time. Optionally filter by process name substring.",
            @"inputSchema": @{
                @"type": @"object",
                @"properties": @{
                    @"filter": @{@"type": @"string", @"description": @"Optional process name substring filter (case-insensitive)"},
                    @"limit": @{@"type": @"number", @"description": @"Max processes to return (default: all)"}
                }
            }
        },
        // ---- go-ios integration: location simulation ----
        @{
            @"name": @"set_location",
            @"description": @"Simulate GPS location on device (requires Developer Mode or jailbreak). Uses CoreLocation private SPI to set a fake coordinate. Call clear_location to stop simulation.",
            @"inputSchema": @{
                @"type": @"object",
                @"properties": @{
        ...
        @{
            @"name": @"clear_location",
            @"description": @"Stop GPS location simulation and restore real location.",
            @"inputSchema": @{@"type": @"object", @"properties": @{}}
        },
        // ---- go-ios integration: device power control ----
        @{
            @"name": @"reboot_device",
            @"description": @"Reboot the device immediately. Tries FBSSystemService, falls back to /sbin/reboot.",
            @"inputSchema": @{@"type": @"object", @"properties": @{}}
        },
        @{
            @"name": @"shutdown_device",
            @"description": @"Shut down the device. Tries FBSSystemService first, falls back to /sbin/halt.",
            @"inputSchema": @{@"type": @"object", @"properties": @{}}
        },
        // ---- go-ios integration: developer features ----
        @{
            @"name": @"enable_devmode",
            @"description": @"Enable Developer Mode on the device (attempts MobileGestalt + AMFI sysctl; full support varies by iOS version).",
            @"inputSchema": @{@"type": @"object", @"properties": @{}}
        },
        @{
            @"name": @"disable_memlimit",
            @"description": @"Disable Jetsam memory limit for the current process (allows larger memory usage without being killed).",
            @"inputSchema": @{@"type": @"object", @"properties": @{}}
        },
        // ---- go-ios integration: accessibility toggles ----
        @{
            @"name": @"assistive_touch",
            @"description": @"Toggle AssistiveTouch on/off. Writes to accessibility preferences and notifies SpringBoard.",
            @"inputSchema": @{
                @"type": @"object",
                @"properties": @{
        ...
        @{
            @"name": @"voiceover",
            @"description": @"Toggle VoiceOver screen reader on/off.",
            @"inputSchema": @{
                @"type": @"object",
                @"properties": @{
                    @"enable": @{@"type": @"boolean", @"description": @"true to enable, false to disable"}
        ...
        @{
            @"name": @"zoom",
            @"description": @"Toggle screen zoom accessibility on/off.",
            @"inputSchema": @{
                @"type": @"object",
                @"properties": @{
                    @"enable": @{@"type": @"boolean", @"description": @"true to enable, false to disable"}
        ...
        // ---- go-ios integration: language & region ----
        @{
            @"name": @"set_language",
            @"description": @"Set the device language (e.g. 'en', 'zh-Hans', 'ja'). Requires respring/reboot to fully apply.",
            @"inputSchema": @{
                @"type": @"object",
                @"properties": @{
                    @"language": @{@"type": @"string", @"description": @"Language code (e.g. en, zh-Hans, ja, ko, fr, de, es)"}
                },
                @"required": @[@"language"]
            }
        },
        @{
            @"name": @"set_locale",
            @"description": @"Set the device region/locale (e.g. 'en_US', 'zh_CN', 'ja_JP'). Requires respring/reboot to fully apply.",
            @"inputSchema": @{
                @"type": @"object",
                @"properties": @{
                    @"locale": @{@"type": @"string", @"description": @"Locale identifier (e.g. en_US, zh_CN, ja_JP, fr_FR)"}
                },
                @"required": @[@"locale"]
            }
        },
        // ---- go-ios integration: network controls ----
        @{
            @"name": @"get_network_info",
            @"description": @"Get comprehensive network info: WiFi/cellular reachability, carrier name/MCC/MNC, radio technology type, locale/timezone, hostname. Combines SCNetworkReachability, CoreTelephony, and NSLocale.",
            @"inputSchema": @{@"type": @"object", @"properties": @{}}
        },
        @{
            @"name": @"enable_wifi",
            @"description": @"Toggle WiFi on/off via SpringBoardServices private framework.",
            @"inputSchema": @{
                @"type": @"object",
                @"properties": @{
                    @"enable": @{@"type": @"boolean", @"description": @"true to enable WiFi, false to disable"}
                },
                @"required": @[@"enable"]
            }
        },
        @{
            ...
            @"description": @"Toggle Bluetooth on/off via SpringBoardServices private framework.",
            @"inputSchema": @{
                @"type": @"object",
                @"properties": @{
                    @"enable": @{@"type": @"boolean", @"description": @"true to enable Bluetooth, false to disable"}
                },
                @"required": @[@"enable"]
            }
        },
        // ---- go-ios integration: configuration profiles ----
        @{
            @"name": @"get_profiles",
            @"description": @"List installed configuration profiles (ManagedConfiguration.framework). Returns identifier, display name, description, locked status, and install date for each profile.",
            @"inputSchema": @{@"type": @"object", @"properties": @{}}
        },
        @{
            @"name": @"install_profile",
            @"description": @"Install a .mobileconfig configuration profile from a file path on device.",
            @"inputSchema": @{
                @"type": @"object",
                @"properties": @{
                    @"path": @{@"type": @"string", @"description": @"Absolute path to .mobileconfig profile file on device"}
                },
                @"required": @[@"path"]
            }
        },
        @{
            @"name": @"remove_profile",
            @"description": @"Remove a configuration profile by its identifier.",
            @"inputSchema": @{
                @"type": @"object",
                @"properties": @{
                    @"identifier": @{@"type": @"string", @"description": @"Profile identifier (from get_profiles)"}
                },
                @"required": @[@"identifier"]
            }
        },
        // ---- go-ios integration: SpringBoard icons ----
        @{
            @"name": @"springboard_icons",
            @"description": @"Get the current SpringBoard home screen icon layout from IconState.plist. Returns per-page icon lists with bundle IDs.",
            @"inputSchema": @{@"type": @"object", @"properties": @{}}
        },
        // ---- go-ios integration: packet capture ----
        @{
            @"name": @"pcap_start",
            @"description": @"Start network packet capture on en0 interface using tcpdump (must be installed). Captures to a pcap file for the specified duration.",
            @"inputSchema": @{
                @"type": @"object",
                @"properties": @{
                    @"path": @{@"type": @"string", @"description": @"Output pcap file path (default: /tmp/ios-mcp-capture.pcap)"},
                    @"duration": @{@"type": @"number", @"description": @"Capture duration in seconds (default: 30, max: 300)"}
                }
            }
        },
        @{
        ...
        // ---- go-ios integration: auto-lock ----
        @{
            @"name": @"get_autolock",
            @"description": @"Get the current auto-lock timeout in seconds. 0 or -1 means Never.",
            @"inputSchema": @{@"type": @"object", @"properties": @{}}
        },
        @{
            @"name": @"set_autolock",
            @"description": @"Set the auto-lock timeout. 0 or -1 = Never. Positive = seconds before auto-lock.",
            @"inputSchema": @{
                @"type": @"object",
                @"properties": @{
                    @"seconds": @{@"type": @"number", @"description": @"Auto-lock timeout in seconds (0 or -1 = Never)"}
                },
                @"required": @[@"seconds"]
            }
        },
        // ---- go-ios integration: extended device info (MobileGestalt) ----
        @{
            @"name": @"mobilegestalt",
            @"description": @"Query extended device information via libMobileGestalt. Returns 50+ hardware/software properties including serial, UDID, model, baseband, cellular capabilities, biometric support, and more. Optionally pass specific keys to query. Also includes locale and network info.",
            @"inputSchema": @{
                @"type": @"object",
                @"properties": @{
                    @"keys": @{@"type": @"array", @"items": @{@"type": @"string"}, @"description": @"Optional array of specific MobileGestalt keys to query (if omitted, returns all common keys)"}
                }
            }
        },
        // ---- LUA scripting tools ----
        @{
            @"name": @"lua_execute",
            @"description": @"Execute a LUA script on the device. The script has access to the `ios` global table with functions: ios.screenshot(), ios.tap(x,y), ios.swipe(x1,y1,x2,y2,duration), ios.long_press(x,y,duration), ios.double_tap(x,y), ios.input_text(text), ios.type_text(text,delay), ios.press_key(key), ios.press_home(), ios.press_power(), ios.press_volume_up(), ios.press_volume_down(), ios.wake_and_home(), ios.launch_app(bundleId), ios.kill_app(bundleId), ios.list_apps(type), ios.list_running_apps(), ios.get_frontmost_app(), ios.get_app_info(bundleId), ios.get_ui_elements(maxElements,visibleOnly,clickableOnly), ios.get_element_at_point(x,y), ios.find_element(text,identifier), ios.wait_for_element(text,timeout_ms), ios.wait_for_disappear(text,timeout_ms), ios.ocr_screen(languages,minConfidence), ios.get_screen_info(), ios.get_clipboard(), ios.set_clipboard(text), ios.open_url(url), ios.get_device_info(), ios.run_command(cmd,timeout), ios.get_brightness(), ios.set_brightness(val), ios.get_volume(), ios.set_volume(val), ios.read_file(path), ios.write_file(path,content), ios.list_dir(path), ios.get_syslog(process,level,seconds), ios.get_crash_logs(bundleId,limit), ios.read_crash_log(path), ios.sleep(ms), ios.log(msg). Returns {success, result, output, error}.",
            @"inputSchema": @{
                @"type": @"object",
                @"properties": @{
                    @"script": @{@"type": @"string", @"description": @"LUA script source code to execute"}
                },
                @"required": @[@"script"]
            }
        },
        @{
            ...
            @"description": @"List all saved LUA scripts in the device's scripts directory",
            @"inputSchema": @{@"type": @"object", @"properties": @{}}
        },
        @{
            @"name": @"lua_get_script",
            @"description": @"Read the content of a saved LUA script by name (with or without .lua extension)",
            @"inputSchema": @{
                @"type": @"object",
                @"properties": @{
                    @"name": @{@"type": @"string", @"description": @"Script file name (e.g. 'my_script' or 'my_script.lua')"}
                },
                @"required": @[@"name"]
            }
        },
        @{
            @"name": @"lua_save_script",
            @"description": @"Save (create or overwrite) a LUA script to the device's scripts directory",
            @"inputSchema": @{
                @"type": @"object",
                @"properties": @{
                    @"name": @{@"type": @"string", @"description": @"Script file name (with or without .lua extension)"},
                    @"script": @{@"type": @"string", @"description": @"LUA script source code to save"}
                },
                @"required": @[@"name", @"script"]
            }
        },
        @{
            @"name": @"lua_delete_script",
            @"description": @"Delete a saved LUA script by name",
            @"inputSchema": @{
                @"type": @"object",
                @"properties": @{
                    @"name": @{@"type": @"string", @"description": @"Script file name to delete"}
                },
                @"required": @[@"name"]
            }
        }
...
- (NSDictionary *)handleToolsCall:(id)reqId params:(NSDictionary *)params {
    ...
    // ---- go-ios integration tools ----
    else if ([toolName isEqualToString:@"get_sysmontap"]) {
        return [self executeGetSysmontap:reqId args:args];
    } else if ([toolName isEqualToString:@"list_processes"]) {
        return [self executeListProcesses:reqId args:args];
    } else if ([toolName isEqualToString:@"set_location"]) {
        return [self executeSetLocation:reqId args:args];
    } else if ([toolName isEqualToString:@"clear_location"]) {
        return [self executeClearLocation:reqId args:args];
    } else if ([toolName isEqualToString:@"reboot_device"]) {
        return [self executeRebootDevice:reqId args:args];
    } else if ([toolName isEqualToString:@"shutdown_device"]) {
        return [self executeShutdownDevice:reqId args:args];
    } else if ([toolName isEqualToString:@"enable_devmode"]) {
        return [self executeEnableDevmode:reqId args:args];
    } else if ([toolName isEqualToString:@"disable_memlimit"]) {
        return [self executeDisableMemlimit:reqId args:args];
    } else if ([toolName isEqualToString:@"assistive_touch"]) {
        return [self executeAssistiveTouch:reqId args:args];
    } else if ([toolName isEqualToString:@"voiceover"]) {
        return [self executeVoiceOver:reqId args:args];
    } else if ([toolName isEqualToString:@"zoom"]) {
        return [self executeZoom:reqId args:args];
    } else if ([toolName isEqualToString:@"set_language"]) {
        return [self executeSetLanguage:reqId args:args];
    } else if ([toolName isEqualToString:@"set_locale"]) {
        return [self executeSetLocale:reqId args:args];
    } else if ([toolName isEqualToString:@"get_network_info"]) {
        return [self executeGetNetworkInfo:reqId args:args];
    } else if ([toolName isEqualToString:@"enable_wifi"]) {
        return [self executeEnableWifi:reqId args:args];
    } else if ([toolName isEqualToString:@"enable_bluetooth"]) {
        return [self executeEnableBluetooth:reqId args:args];
    } else if ([toolName isEqualToString:@"get_profiles"]) {
        return [self executeGetProfiles:reqId args:args];
    } else if ([toolName isEqualToString:@"install_profile"]) {
        return [self executeInstallProfile:reqId args:args];
    } else if ([toolName isEqualToString:@"remove_profile"]) {
        return [self executeRemoveProfile:reqId args:args];
    } else if ([toolName isEqualToString:@"springboard_icons"]) {
        return [self executeSpringboardIcons:reqId args:args];
    } else if ([toolName isEqualToString:@"pcap_start"]) {
        return [self executePcapStart:reqId args:args];
    } else if ([toolName isEqualToString:@"pcap_stop"]) {
        return [self executePcapStop:reqId args:args];
    } else if ([toolName isEqualToString:@"get_autolock"]) {
        return [self executeGetAutolock:reqId args:args];
    } else if ([toolName isEqualToString:@"set_autolock"]) {
        return [self executeSetAutolock:reqId args:args];
    } else if ([toolName isEqualToString:@"mobilegestalt"]) {
        return [self executeMobilegestalt:reqId args:args];
    }
    // ---- LUA scripting tools ----
    else if ([toolName isEqualToString:@"lua_execute"]) {
        return [self executeLuaExecute:reqId args:args];
    } else if ([toolName isEqualToString:@"lua_list_scripts"]) {
        return [self executeLuaListScripts:reqId];
    } else if ([toolName isEqualToString:@"lua_get_script"]) {
        return [self executeLuaGetScript:reqId args:args];
    } else if ([toolName isEqualToString:@"lua_save_script"]) {
        return [self executeLuaSaveScript:reqId args:args];
    } else if ([toolName isEqualToString:@"lua_delete_script"]) {
        return [self executeLuaDeleteScript:reqId args:args];
    }
...
#pragma mark - LUA Scripting Execution

- (NSDictionary *)executeLuaExecute:(id)reqId args:(NSDictionary *)args {
    NSString *paramError = nil;
    NSString *script = nil;
    if (!MCPStringFromArgs(args, @"script", YES, &script, &paramError)) {
        return [self mcpError:reqId code:-32602 message:paramError];
    }
    if (script.length == 0) {
        return [self mcpError:reqId code:-32602 message:@"script cannot be empty"];
    }

    NSDictionary *result = [[LuaManager sharedInstance] executeScript:script];
...
- (NSDictionary *)executeLuaListScripts:(id)reqId {
    NSArray *scripts = [[LuaManager sharedInstance] listScripts];
    return [self mcpSuccess:reqId structuredContent:@{@"scripts": scripts ?: @[]}];
}

- (NSDictionary *)executeLuaGetScript:(id)reqId args:(NSDictionary *)args {
    NSString *paramError = nil;
    NSString *name = nil;
    if (!MCPStringFromArgs(args, @"name", YES, &name, &paramError)) {
        return [self mcpError:reqId code:-32602 message:paramError];
    }

    NSString *content = [[LuaManager sharedInstance] readScriptNamed:name];
    if (content) {
        return [self mcpSuccess:reqId structuredContent:@{@"name": name, @"script": content}];
    }
    return [self mcpSuccess:reqId text:[NSString stringWithFormat:@"Script not found: %@", name] isError:YES];
}

- (NSDictionary *)executeLuaSaveScript:(id)reqId args:(NSDictionary *)args {
    NSString *paramError = nil;
    NSString *name = nil;
    NSString *script = nil;
    if (!MCPStringFromArgs(args, @"name", YES, &name, &paramError) ||
        !MCPStringFromArgs(args, @"script", YES, &script, &paramError)) {
        return [self mcpError:reqId code:-32602 message:paramError];
    }

    NSError *error = nil;
    BOOL ok = [[LuaManager sharedInstance] saveScript:script named:name error:&error];
    if (ok) {
        return [self mcpSuccess:reqId text:[NSString stringWithFormat:@"Script saved: %@", name]];
    }
    return [self mcpSuccess:reqId text:[NSString stringWithFormat:@"Save failed: %@", error.localizedDescription] isError:YES];
}

- (NSDictionary *)executeLuaDeleteScript:(id)reqId args:(NSDictionary *)args {
    NSString *paramError = nil;
    NSString *name = nil;
    if (!MCPStringFromArgs(args, @"name", YES, &name, &paramError)) {
        return [self mcpError:reqId code:-32602 message:paramError];
    ...
    NSError *error = nil;
    BOOL ok = [[LuaManager sharedInstance] deleteScriptNamed:name error:&error];
    if (ok) {
        return [self mcpSuccess:reqId text:[NSString stringWithFormat:@"Script deleted: %@", name]];
    }
    return [self mcpSuccess:reqId text:[NSString stringWithFormat:@"Delete failed: %@", error.localizedDescription] isError:YES];
}
